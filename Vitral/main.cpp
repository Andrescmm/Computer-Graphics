...
int main() {
    ...
    unsigned int fragmentBrown = glCreateShader(GL_FRAGMENT_SHADER);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(verticesCentralD), verticesCentralD, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
    glEnableVertexAttribArray(0);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(verticesCentralI), verticesCentralI, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
    glEnableVertexAttribArray(0);
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(verticesPetaloC), verticesPetaloC, GL_STATIC_DRAW);
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0);
    glEnableVertexAttribArray(0);
