...
int main() {
    ...
    while (true) {
        ...
        if (glfwGetKey(window, GLFW_KEY_R) == GLFW_PRESS) {
            angle = 30;
            rotateM(verticesMarco, angle);
            rotateM(verticesFondo, angle);
            rotateM(verticesTallo, angle);
            rotateM(verticesCentralD, angle);
            rotateM(verticesCentralI, angle);
            rotateM(verticesHojasI, angle);
            rotateM(verticesHojasD, angle);
            rotateM(verticesPetaloI, angle);
            rotateM(verticesPetaloD, angle);
            rotateM(verticesPetaloC, angle);
            drawFlower();
        }
        ...
        if (glfwGetKey(window, GLFW_KEY_F) == GLFW_PRESS) {
            ...
            scaleM(verticesMarco, W, H);
            scaleM(verticesFondo, W, H);
            scaleM(verticesTallo, W, H);
            scaleM(verticesCentralD, W, H);
            scaleM(verticesCentralI, W, H);
            scaleM(verticesHojasI, W, H);
            scaleM(verticesHojasD, W, H);
            scaleM(verticesPetaloI, W, H);
            scaleM(verticesPetaloD, W, H);
            scaleM(verticesPetaloC, W, H);
            drawFlower();
        }
        ...
        if (glfwGetKey(window, GLFW_KEY_T) == GLFW_PRESS) {
            ...
            Y = Y + 0.001;
                ...
                transM(verticesMarco, X, Y);
                transM(verticesFondo, X, Y);
                transM(verticesTallo, X, Y);
                transM(verticesCentralD, X, Y);
                transM(verticesCentralI, X, Y);
                transM(verticesHojasI, X, Y);
                transM(verticesHojasD, X, Y);
                transM(verticesPetaloI, X, Y);
                transM(verticesPetaloD, X, Y);
                transM(verticesPetaloC, X, Y);
                drawFlower();
