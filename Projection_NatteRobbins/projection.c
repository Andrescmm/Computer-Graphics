...
drawmodel(void)
{
    if (!pmodel) 
	{
		...
		pmodel = glmReadOBJ("D:/data/al.obj");
...
screen_menu(int value)
{
    ...
    case 's':
		...
		name = "D:/data/soccerball.obj";

		break;
    case 'd':
        //name = "data/dolphins.obj";
		name = "D:/data/dolphins.obj";

        break;
    case 'f':
        //name = "data/flowers.obj";
		name = "D:/data/flowers.obj";

        break;
    case 'j':
        //name = "data/f-16.obj";
		name = "D:/data/f-16.obj";

        break;
    case 'p':
        //name = "data/porsche.obj";
		name = "D:/data/porsche.obj";

        break;
    case 'r':
        //name = "data/rose+vase.obj";
		name = "D:/data/rose+vase.obj";
